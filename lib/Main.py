...
def main():
    # Adding sample data
    author1 = Author("Diane Oliver")
    author2 = Author("Richard Wall")

    magazine1 = Magazine("American Short Fiction", "Fiction")
    magazine2 = Magazine("Just For Now", "Comic")

    author1.add_article(magazine1, "Spiders Cry without tears")
    author1.add_article(magazine1, "EOD")
    author2.add_article(magazine1, "The Postman")

    author2.add_article(magazine2, "Ghost Squad")
    author2.add_article(magazine2, "The Butcher of Derby")
